...
YELP_CLIENT_ID=getattr(settings,'YELP_CLIENT_ID','i6tV7wSxjC4FI5Yyf8DIEQ')
YELP_CLIENT_SECRET=getattr(settings,'YELP_CLIENT_SECRET','BEglifXmpwBSOwZ6KX5SYjbhnLVwkmcCaU6QDdMroi3l0InrTah5J5OoPZIyJvKW')
